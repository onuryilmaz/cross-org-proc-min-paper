...
\usepackage{url}
\urldef{\mailsa}\path|{yilmaz.onur, karagoz,}@metu.edu.tr|    
...
%
\author{Onur Yilmaz \and Pınar Karagoz}
%
...
\institute{Computer Engineering Deperatment, Middle East Technical University, Turkey}
\mailsa\\
\url{http://ceng.metu.edu.tr}}
