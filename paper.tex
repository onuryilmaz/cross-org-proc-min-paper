...
\title{Generating Performance Improvement Suggestions by using Cross-Organizational Process Mining}
...
\institute{\email{\{onur.yilmaz, karagoz\}@ceng.metu.edu.tr} \\ Computer Engineering Department, Middle East Technical University, Turkey}
...
\input{3_background/background.tex}
\input{4_methodology/methodology.tex}
\input{5_results_discussions/results_discussions.tex}
\input{6_conclusion_future_work/conclusion_future_work.tex}
